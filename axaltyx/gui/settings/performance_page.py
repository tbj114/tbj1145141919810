...
class PerformancePage(QWidget):
    ...
    def _init_ui(self):
        ...
        # 并行处理
        self.parallel_processing_checkbox = QCheckBox("并行处理")
        ...
        block_size_layout.addWidget(QLabel("数据块大小"))
        ...
        # 启用数据压缩
        self.compression_checkbox = QCheckBox("启用数据压缩")
        processing_layout.addWidget(self.compression_checkbox)

        # 启用数据预加载
        self.preload_checkbox = QCheckBox("启用数据预加载")
